...
Données utilisées
[https://archive.ics.uci.edu/dataset/492/metro+interstate+traffic+volume](lien dataset)
Le dataset contient des variables :

 Météo : température, pluie, neige, couverture nuageuse, type de temps ⏰ Temps : heure, jour de la semaine, mois, week-end, jour férié 🚦   Cible : volume de trafic (traffic_volume)
